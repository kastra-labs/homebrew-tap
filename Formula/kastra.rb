class Kastra < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "aee6ba5d86926fcb01eb493abbf8d9daf53115c06af11f7905b4d719b4d8b106"
    else
      url "https://github.com/kastra-labs/kastra-edge-releases/releases/download/cli-v#{version}/kastra-darwin-amd64.tar.gz"
      sha256 "a629bf91a092c392c47992b00e8407600f33d93bb1e3ba727aa29f843264bd08"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "a1192d11ae1aa7fa6247c15d0fe06e8628daee418c01db850bb1d2c2df8ad907"
    else
      url "https://github.com/kastra-labs/kastra-edge-releases/releases/download/cli-v#{version}/kastra-linux-amd64.tar.gz"
      sha256 "b3aa32446ae9b8516e5f8455cc939a82acbfc6413baf3831abb28adaebfb5e55"
    end
  end
